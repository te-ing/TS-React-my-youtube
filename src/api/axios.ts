...
const DUMMY = formatSearchResult([
  {
    ...
    snippet: {
      ...
      description:
        "[MV] GFRIEND(여자친구) _ Summer Rain(여름비) *English subtitles are now available. (Please click on 'CC' button or activate ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "KPOP Chart Show M COUNTDOWN | EP.541 - GFRIEND - SUMMER RAIN ▷Watch more video clips: ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      title:
        "170914 여자친구 (GFRIEND) - 여름비 (SUMMER RAIN) (은하) 직캠 by 수원촌놈 [엠카 미니팬미팅]",
      description: "",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      channelId: "UCweOkPb1wVVH0Q0Tlj4a5Pw",
      title:
        "[Mirrored] GFRIEND(여자친구) _ &#39;SUMMER RAIN&#39; Choreography(여름비 거울모드 안무영상)_1theK Dance Cover Contest",
      description:
        "[Mirrored] GFRIEND(여자친구) _ 'SUMMER RAIN' Choreography(여름비 거울모드 안무영상)_1theK Dance Cover Contest ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "GFRIEND 여자친구 facebook: http://www.facebook.com/gfrdofficial GFRIEND 여자친구 twitter: http://twitter.com/gfrdofficial ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "Provided to YouTube by Loen Entertainment Summer Rain (여름비) · GFRIEND(여자친구) GFRIEND (여자친구) The 5th Mini ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      title: "여름비",
      description:
        "Provided to YouTube by NHN BUGS 여름비 · Sam Kim 그 해 우리는 OST Part.8 ℗ 모스트콘텐츠 Released on: 2022-01-10 ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "여자친구 GFRIEND - 여름비 교차편집 Summer Rain Stage Mix 여자친구 여름비 교차편집.",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "딩고 뮤직 구독하기 click https://www.youtube.com/channel/UCtCiO5t2voB14CmZKTkIzPQ?sub_confirmation=1 나만을 위해 불러 ...",
      thumbnails: {
        default: {
